...
//insert into faculty
router.post('/insert/faculty', function(req, res, next){ 
...
//insert into faculty
router.put('/update/faculty/:id', function(req, res, next){
  ...
  oracledb.getConnection(
    ...
    function (err, connection) {
      ...
      connection.execute(
        "BEGIN update_faculty(:id, :i, :o); END;",
        bindvars,
        function (err, result) {
          if (err) {
            console.error(err.message);
